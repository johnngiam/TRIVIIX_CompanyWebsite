    ...
    <div className="App">
      ...
      <header className="page-header navbar page-header-alpha scrolled-white menu-right topmenu-right">
        ...
        <a className="navbar-brand" href="#home">
          <span className="logo">
            <img className="light-logo" src="../src/css/img/logo.png" alt="Logo" />
          </span>
          <span className="text">
          ...
          <nav className="navbar-mainmenu">
            <ul className="navbar-nav mr-auto">
              <li className="nav-item active">
                <a className="nav-link" href="./index.html#home">Home <span className="sr-only">(current)</span></a>
              </li>
      ...
      <main class="page-main page-fullpage main-anim" id="mainpage">
                ...
                <div class="col-12 col-md-6 text-left">
                  <div class="title-desc">
                    ...
                    <span class="line line1" id="line"></span>
                      <h2 class="display-4 display-title home-title anim-1 letters">De &#8226; AI</h2>
        ...
        <div class="section section-description fp-auto-height-responsive " data-section="about">
          <div class="section-wrapper center-vh dir-col anim">
            <div class="section-title text-center">
              ...
              <h2 class="display-4 display-title anim-2 illustr zoomout-1 ml12">Everything is possible</h2>
            </div>

            <div class="section-content reduced anim text-center">
              <div class="title-desc anim-3">
              <p id="txtabout" class="typewriter" data-period="5000" data-type='[ "Dream, dream, dream! Conduct these dreams into thought, and then transform them into action. With us, your dream can put into action." ]'>
        ...
        <div class="section section-list-feature fp-auto-height-responsive " data-section="about1">
        ...
        <div class="section section-list-feature fp-auto-height-responsive " data-section="services">
          <div class="section-wrapper twoside anim">
            ...
            <p id="txtabout" class="section-title text-center anim-2 typewriter" data-period="5000" data-type='[ "What we can provide to you are out of your imagination." ]'>
                  <span class="wrap"></span>
              </p>
                ...
                <div class="section-content zoomout-1 fade-4">
                  <div class="media">
                    ...
                    <div class="media-body">
                      ...
                      <p class='text-justify'>Create alluring and crackerjack mobile application and web development services for you. Your users will be "The Fan of Your Brand"</p>
                    </div>
                  </div>
                  ...
                  <div class="media">
                    ...
                    <div class="media-body">
                      ...
                      <p class='text-justify'>Let AI make faster, automated and more accurate decisions for you.</p>
                    </div>
                  </div>
                  ...
                  <div class="media">
                    ...
                    <div class="media-body">
                      ...
                      <p class='text-justify'>Let your users to be able to immerse deeper in your imagination world.</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="section-content zoomout-1 fade-1">
                  <div class="media">
                    ...
                    <div class="media-body">
                      ...
                      <p class='text-justify'>Having fun and interative training workshop that make sure you will gain something after end of the workshop.</p>
                    </div>
                  </div>
                  ...
                  <div class="media">
                    ...
                    <div class="media-body">
                      <h4>Online Course</h4>
                      <p class='text-justify'>Building knowledge, skills and competence in computer science field through virtual classes with our professional trainers. </p>
                    </div>
                  </div>
                  ...
                  <div class="media">
                    ...
                    <div class="media-body">
                      ...
                      <p class='text-justify'>Feel connected with your devices by getting IoT development services provided by us.</p>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <div class="hover-area">
                        <div class="card">
                          ...
                          <div class="card__back">
                            <h3><strong>e-Commerce Website & Application</strong></h3>
                            <p>Start your business online today to improve your business services.
                              We provide eCommerce solutions to meet your requirements or budgets. 
                              <a class="btn-transp-arrow btn-round" href="index.html#home"> –Learn More- </a>
                      ...
                      <div class="hover-area">
                          <div class="card">
                            ...
                            <div class="card__back">
                              ...
                              <p>We provide the solutions by integrating the virtual and the real world.
                                Our team is experienced IT professionals who create interactive content
                                as it engaging and immersive experiences that present real-life opportunities
                                for training and development. It all begins here.
                                <a class="btn-transp-arrow btn-round" href="index.html#home" > –Learn More </a>
                                {/* style="background: #b02b4c;" */}
                              </p>
                            </div>
                    ...
                    <div class="swiper-slide slide-item-a">
                      <div class="hover-area"> 
                          <div class="card">
                            ...
                            <div class="card__back">
                              <h3><strong>3D Model and Training Workshop</strong></h3>
                              <p>By using photogrammetry techniques and professional tools
                                and we are produced the detailed 3D models in computer. 
                                We do provide training workshop!
                                <a class="btn-transp-arrow btn-round" href="index.html#home" > –Learn More </a>
                                {/* style="background: #b02b4c;" */}
                              </p>
                            </div>                      
                    ...
                    <div class="img-avatar-alpha">
                      <div class="img-1 shadow">
                        <a href="index.html#register">
                          <img class="img" src="img/items/img-people1-square.jpg" alt=""/>
                        </a>
                      </div>
                      <div class="legend text-center pos-abs">
                        ...
                        <div class="icons">
                          <a class="icon-btn" href="https://www.instagram.com/" target="_blank" rel='noreferrer'>
                            <i class="icon fa fa-instagram"></i>
                          </a>
                          <a class="icon-btn" href="https://twitter.com/" target="_blank" rel='noreferrer'>
                ...
                <div class="section-content anim text-left">
                  <div class="title-desc">
                    <div class="anim-2">
                      ...
                      <p>Interested in learning more about our services? 
                        <br/>For questions about our company and products, Contact us.
                        <br/>We ensure you will receiving the best information possible. 
                        <br/>From basic questions to complex compliance inquiries, 
                  ...
                  <div class="address-container anim-3">
                    <div class="row">
                      ...
                      <div class="col-12 col-md-12 col-lg-6">
                        ...
                        <p>
                          Company address
                          <br/>TIC Main Office, FCSIT
                          <br/>Universiti Malaysia Sarawak
                          <br/>94300 Kota Samarahan, Sarawak.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="section-content anim text-left">
                  <div class="title-desc">
                    <div>
                      ...
                      <p> Want to get more information? Here's how you can reach us by email. Send your enquiries and we will get back to you shortly! </p>
                    </div>
                  </div>
                    ...
                    <div class="form-container form-container-card">
                      <form class="send_message_form message form" method="post" action="ajaxserver/serverfile.php"
                        ...
                        <div class="form-group no-border">
                          ...
                          <div>
                            <p class="message-ok invisible form-text-feedback form-success-visible">Your message has been
                              sent, thank you.</p>
                          </div>
                        </div>
      ...
      <footer id="site-footer" class="page-footer">
        ...
        <div class="footer-right">
          <ul class="social">
            <li><a href="https://en-gb.facebook.com/login.php" target="_blank" rel='noreferrer'><i class="icon fa fa-facebook"></i></a></li>
            <li><a href="https://twitter.com/" target="_blank" rel='noreferrer'><i class="icon fa fa-twitter"></i></a></li>
            <li><a href="https://www.instagram.com/" target="_blank" rel='noreferrer'><i class="icon fa fa-instagram"></i></a></li>
          </ul>
        </div>
      </footer>
    </div>
